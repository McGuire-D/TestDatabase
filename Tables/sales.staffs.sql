...
GO
ALTER TABLE [sales].[staffs] ADD CONSTRAINT [PK__staffs__1963DD9CCE81CC0E] PRIMARY KEY CLUSTERED ([staff_id]) ON [PRIMARY]
GO
ALTER TABLE [sales].[staffs] ADD CONSTRAINT [UQ__staffs__AB6E61647A17BA64] UNIQUE NONCLUSTERED ([email]) ON [PRIMARY]
GO
